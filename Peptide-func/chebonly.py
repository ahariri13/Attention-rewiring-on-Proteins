...
Original file is located at
    https://colab.research.google.com/drive/1icFUUaQIT2488eKNLqKjoIO_0N5uRIje
"""
...
parser.add_argument('--hidden', type=int, default=180, help='Latent Dimension')
parser.add_argument('--RW', type=int, default=8, help='Latent Dimension')
parser.add_argument('--seed', type=int, default=433, help='Latent Dimension')
...
parser.add_argument('--lamb', type=float, default=0, help='Regularizer')
parser.add_argument('--webdata', type=str, default='wqehqwekwjqne', help='which data')
...
class HNO(torch.nn.Module):
    ...
    def __init__(self,):
        ...
        self.conv1 = ChebConv(total_feats, int(2*args.hidden),K=9)
        self.conv2 = ChebConv(int(2*args.hidden), int(2*args.hidden),K=8)
        self.conv3 = ChebConv(int(2*args.hidden), args.hidden,K=7)
        self.conv4 = ChebConv(int(args.hidden), args.hidden,K=6)
...
wandb.init(
project="ChebNet_Only",
name="4Cheb_PeptideFunc",
config=config,
)
