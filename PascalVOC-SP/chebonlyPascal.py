...
parser.add_argument('--seed', type=int, default=110, help='Latent Dimension')
...
parser.add_argument('--webdata', type=str, default='gffdxrsrsres', help='which data')
