...
parser.add_argument('--seed', type=int, default=124, help='Latent Dimension')
...
parser.add_argument('--webdata', type=str, default='ewirjwi', help='which data')
