...
class HNO(torch.nn.Module):
    ...
    def __init__(self,):
        ...
        self.conv1 = GATConv(total_feats, int(2*args.hidden))#,K=6)
        ...
        self.conv2 = GATConv(int(2*args.hidden), int(2*args.hidden))#,K=6)
        self.conv3 = GATConv(int(2*args.hidden), args.hidden)#,K=6)
        self.conv4 = GATConv(int(args.hidden), args.hidden)#,K=6)
